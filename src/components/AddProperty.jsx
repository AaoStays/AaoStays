  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        baseGuest: Number(formData.baseGuests),
        maxGuest: Number(formData.maxGuests),
        cleaningFee: Number(formData.cleaningFee),
        extraGuestFee: Number(formData.extraGuestFee),
        primaryMobile:Number(formData.primaryMobile)
          ...
          <div className="form-section">
            ...
            <div className="form-group">
              ...
              Property Amenities 
               ...
               <div className="form-group">
                <label>
                Amenity notes <span className="required">*</span>
                </label>
                <input
                  type="text"
                  name="notes"
                  placeholder="describe your amenity"
