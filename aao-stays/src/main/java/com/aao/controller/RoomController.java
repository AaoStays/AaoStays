...
public class RoomController {
    ...
    public ResponseEntity<ApiResponse<RoomResponseDto>> bookRoom(
            @PathVariable Long roomId,
            @RequestBody RoomBookingRequestDto dto) {

        ApiResponse<RoomResponseDto> response = roomService.bookRoom(roomId, dto);
        return ResponseEntity.status(response.getStatusCode()).body(response);
    }
